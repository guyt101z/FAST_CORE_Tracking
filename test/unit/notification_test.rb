...
class NotificationTest < ActiveSupport::TestCase
  ...
  context "A feedback notification" do
    ...
    should "have the proper content" do
      assert_equal "Feedback from qwerty.#{DOMAIN}", @response.subject
      assert_equal SUPPORT_EMAIL, @response.destinations[0]
    end
  end
  ...
  context "A reading notification" do
    setup do
      ...
      # Commenting for now until we can figure out why Time.zone is not persisted in test mode
      # See line 179 in app/models/notifier.rb
