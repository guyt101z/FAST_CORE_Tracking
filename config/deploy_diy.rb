# Modify the following variables for your FAST SVN credentials
...
task :production do
  ...
  set :monited, 'y'
  role :db, "YOUR_PRODUCTION_SERVER_ADDRESS", :primary => true
  app_servers = ["YOUR_PRODUCTION_SERVER_ADDRESS"]
  ...
  set :repository, "https://svn.numerexfast.com/repos/fast/Ublip_v2/branches/YOUR_SVN_BRANCH_NAME/trunk"
end

task :staging do
  set :rails_env, 'staging'
  set :monited, 'n'
  role :db, 'YOUR_STAGING_SERVER_ADDRESS', :primary => true
  role :app, 'YOUR_STAGING_SERVER_ADDRESS', :mongrel => true
  set :repository, "https://svn.numerexfast.com/repos/fast/Ublip_v2/branches/YOUR_SVN_BRANCH_NAME/trunk"
end
 ...
 DESC
  task :restart, :roles => :app do
    if monited.eql?("y")
      ...
      run "cd /opt/ublip/rails/current; mongrel_rails cluster::restart --clean;"
    end
  end
